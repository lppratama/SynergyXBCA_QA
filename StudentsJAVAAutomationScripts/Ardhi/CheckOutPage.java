...
public class CheckOutPage extends BasePage {
    ...
    public static void checkout() {
        ...
        WebElement we = webdriver.findElement(By.cssSelector("#center_column > ul > li > div > div.right-block"));
        action.moveToElement(we).moveToElement(webdriver.findElement(By.xpath("/html/body/div/div[2]/div/div[3]/div[2]/ul/li/div/div[2]/div[2]/a[1]/span"))).click().build().perform();
